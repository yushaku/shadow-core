...
import {SafeCast} from "contracts/CL/core/libraries/SafeCast.sol";
import {IRamsesV3Pool} from "contracts/CL/core/interfaces/IRamsesV3Pool.sol";
import {IUniswapV3SwapCallback} from "contracts/CL/core/interfaces/callback/IUniswapV3SwapCallback.sol";
...
abstract contract V3SwapRouter is UniswapImmutables, Permit2Payments, IUniswapV3SwapCallback {
	...
	function _swap(
		...
		(amount0Delta, amount1Delta) = IRamsesV3Pool(computePoolAddress(tokenIn, tokenOut, fee))
			.swap(
				recipient,
				zeroForOne,
				amount,
