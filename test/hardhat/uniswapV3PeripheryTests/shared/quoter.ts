...
import { ClPoolFactory, MockTimeNonfungiblePositionManager } from "./../../../typechain-types";
...
export async function createPool(
  ...
  await factory.createPool(tokenAddressA, tokenAddressB, FeeAmount.MEDIUM, encodePriceSqrt(1, 1));
