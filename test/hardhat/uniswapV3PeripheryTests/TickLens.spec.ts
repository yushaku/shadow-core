...
describe("TickLens", () => {
    ...
    describe("#getPopulatedTicksInWord", () => {
        ...
        it("works for min/max and -2/-1/0/1", async () => {
            ...
            const [negativeOne, negativeTwo] =
                await tickLens.getPopulatedTicksInWord(
                    poolAddress,
            ...
            expect(zero.liquidityNet).to.be.eq(
            ...
            expect(one.liquidityNet).to.be.eq(
                -liquidity2 - liquidity4 - liquidity5
            );
            expect(one.liquidityGross).to.be.eq(
                liquidity2 + liquidity4 + liquidity5
            );
