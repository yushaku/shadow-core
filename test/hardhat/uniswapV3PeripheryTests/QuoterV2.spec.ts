...
describe("QuoterV2", function () {
    ...
    const swapRouterFixture: () => Promise<{
        ...
        const { weth9, factory, router, tokens, nft, quoterV2 } =
    ...
    describe("quotes", () => {
        ...
        describe("#quoteExactInput", () => {
            it("0 -> 2 cross 2 tick", async () => {
                ...
                expect(sqrtPriceX96AfterList[0]).to.eq(
            ...
            it("0 -> 2 -> 1", async () => {
                ...
                expect(sqrtPriceX96AfterList[1]).to.eq(
                    "80007846861567212939802016351"
                );
                expect(initializedTicksCrossedList[0]).to.eq(2);
        ...
        describe("#quoteExactInputSingle", () => {
            it("0 -> 2", async () => {
                ...
                expect(sqrtPriceX96After).to.eq(
                    "78461846509168490764501028180"
                );
            });
        ...
        describe("#quoteExactOutput", () => {
            ...
            it("0 -> 2 -> 1", async () => {
                ...
                expect(sqrtPriceX96AfterList.length).to.eq(2);
                expect(sqrtPriceX96AfterList[0]).to.eq(
                    "80007838904387594703933785072"
                );
                expect(sqrtPriceX96AfterList[1]).to.eq(
                    "78461888503179331029803316753"
                );
                expect(initializedTicksCrossedList[0]).to.eq(0);
