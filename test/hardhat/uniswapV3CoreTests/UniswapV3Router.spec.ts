...
describe("UniswapV3Pool", () => {
  ...
  describe("multi-swaps", () => {
    ...
    beforeEach("initialize both pools", async () => {
      ...
      await pool0Functions.mint(wallet.address, 0n, minTick, maxTick, expandTo18Decimals(1n));
      await pool1Functions.mint(wallet.address, 0n, minTick, maxTick, expandTo18Decimals(1n));
    });
