...
describe("ClPool", () => {
  ...
  let swapTargetCallee: TestClPoolCallee;
  let swapTargetRouter: TestClPoolRouter;
  ...
  beforeEach("deploy first fixture", async () => {
    ...
    const createPoolWrapped = async (
      ...
      const pool = await createPool(amount, BigNumber.from(0), spacing, firstToken, secondToken);
